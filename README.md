## Welcome to a modified version Udacity's Self-Driving Car Simulator 
...
The changes include adding the ability to collect segmented photos, and create a reinforcement learning based autonomous vehicle.
